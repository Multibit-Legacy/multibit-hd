...
public class ContactsProtobufSerializer {
   ...
   * <p>A Contacts db can be unreadable for various reasons, such as inability to present the file, corrupt data, internally
   ...
   *
   * <p>A contact db can be unreadable for various reasons, such as inability to present the file, corrupt data, internally
