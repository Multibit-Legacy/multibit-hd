...
/**
 *  <p>Class to provide the following to [related classes]:<br>
 *  <ul>
 *  <li>Build mbhd.checkpoints file. This is the same as the bitcoinj BuildCheckpoints except with different output files, DNSDiscovery and Java 7</li>
 *  </ul>
 *  Example:<br>
 *  <pre>
 *  </pre>
