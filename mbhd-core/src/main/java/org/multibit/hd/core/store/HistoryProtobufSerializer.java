...
public class HistoryProtobufSerializer {
   ...
   * <p>A HistoryEntry db can be unreadable for various reasons, such as inability to openWalletFromWalletId the file, corrupt data, internally
   ...
   *
   * <p>A history db can be unreadable for various reasons, such as inability to openWalletFromWalletId the file, corrupt data, internally
