...
//      if (Protos.Wallet.EncryptionType.UNENCRYPTED == perWalletModelData.getWallet().getEncryptionType()) {
...
//   * @param reusePreviousBackupDate Reuse the previously created backup date so that wallet and wallet info names match
...
//            if (Protos.Wallet.EncryptionType.UNENCRYPTED == loadedWallet.getEncryptionType()) {
