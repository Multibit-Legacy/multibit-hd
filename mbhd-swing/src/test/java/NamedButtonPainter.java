...
final class NamedButtonPainter extends AbstractRegionPainter {
  ...
  private Color color1 = adjustColor("aardvark", -0.027777791f, -0.06885965f, -0.36862746f, -190);
  ...
  private Color color17 = adjustColor("aardvark", 0.0f, -0.110526316f, 0.25490195f, -95);
  ...
  private Color color25 = adjustColor("aardvark", -0.027777791f, -0.06885965f, -0.36862746f, -232);
  private Color color26 = adjustColor("aardvark", 0.0f, -0.06766917f, 0.07843137f, 0);
  private Color color27 = adjustColor("aardvark", 0.0f, -0.06484103f, 0.027450979f, 0);
  private Color color28 = adjustColor("aardvark", 0.0f, -0.08477524f, 0.16862744f, 0);
  private Color color29 = adjustColor("aardvark", -0.015872955f, -0.080091536f, 0.15686274f, 0);
  private Color color30 = adjustColor("aardvark", 0.0f, -0.07016757f, 0.12941176f, 0);
  private Color color31 = adjustColor("aardvark", 0.0f, -0.07052632f, 0.1372549f, 0);
  private Color color32 = adjustColor("aardvark", 0.0f, -0.070878744f, 0.14509803f, 0);
  private Color color33 = adjustColor("aardvark", -0.055555522f, -0.05356429f, -0.12549019f, 0);
  private Color color34 = adjustColor("aardvark", 0.0f, -0.0147816315f, -0.3764706f, 0);
  private Color color35 = adjustColor("aardvark", 0.055555582f, -0.10655806f, 0.24313724f, 0);
  private Color color36 = adjustColor("aardvark", 0.0f, -0.09823123f, 0.2117647f, 0);
  private Color color37 = adjustColor("aardvark", 0.0f, -0.0749532f, 0.24705881f, 0);
  private Color color38 = adjustColor("aardvark", 0.0f, -0.110526316f, 0.25490195f, 0);
  private Color color39 = adjustColor("aardvark", 0.0f, -0.020974077f, -0.21960783f, 0);
  private Color color40 = adjustColor("aardvark", 0.0f, 0.11169591f, -0.53333336f, 0);
  private Color color41 = adjustColor("aardvark", 0.055555582f, -0.10658931f, 0.25098038f, 0);
  private Color color42 = adjustColor("aardvark", 0.0f, -0.098526314f, 0.2352941f, 0);
  private Color color43 = adjustColor("aardvark", 0.0f, -0.07333623f, 0.20392156f, 0);
  private Color color44 = new Color(245, 250, 255, 160);
  private Color color45 = adjustColor("aardvark", 0.055555582f, 0.8894737f, -0.7176471f, 0);
  private Color color46 = adjustColor("aardvark", 0.0f, 5.847961E-4f, -0.32156864f, 0);
  private Color color47 = adjustColor("aardvark", -0.00505054f, -0.05960039f, 0.10196078f, 0);
  private Color color48 = adjustColor("aardvark", -0.008547008f, -0.04772438f, 0.06666666f, 0);
  private Color color49 = adjustColor("aardvark", -0.0027777553f, -0.0018306673f, -0.02352941f, 0);
  private Color color50 = adjustColor("aardvark", -0.0027777553f, -0.0212406f, 0.13333333f, 0);
  private Color color51 = adjustColor("aardvark", 0.0055555105f, -0.030845039f, 0.23921567f, 0);


  //Array of current component colors, updated in each paint call
  private Object[] componentColors;

  public NamedButtonPainter(int state) {
    super();
    this.state = state;
   ...
   * defaults.
   *
   * @param key     A key corresponding to the value in the UI Defaults table of UIManager where the base color is defined
   ...
   */
  public Color adjustColor(String key, float hOffset, float sOffset, float bOffset, int aOffset) {

    if (key.startsWith("aardvark")) {
      Color src = (Color) UIManager.get(key);
