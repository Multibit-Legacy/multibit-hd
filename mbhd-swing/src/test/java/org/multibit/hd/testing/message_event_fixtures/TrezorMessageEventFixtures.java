 ...
 *  
 */
class TrezorMessageEventFixtures {

  public static final Logger log = LoggerFactory.getLogger(TrezorMessageEventFixtures.class);
  ...
  /**
   * @return A new standard public static key for M (abandon)
   */
  ...
  /**
   * @return A new standard public static key for M/44H (abandon)
   */
  ...
  /**
   * @return A new standard public static key for M/44H/0H (abandon)
   */
  ...
  /**
   * @return A new standard public static key for M/44H/0H/0H (abandon)
   */
