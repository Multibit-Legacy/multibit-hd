 ...
 *  
 */
public class TrezorInitialisedSignTransactionFixture extends AbstractHardwareWalletFixture {

  public TrezorInitialisedSignTransactionFixture(String name) {
    super(name);
  }
   ...
   */
  @SuppressWarnings("unchecked")
  private void mockSignTransaction(HardwareWalletClient client) {
    useSignTxPIN(client);
  }
