 ...
 * </ul>
 *
 * <p>These message event fixtures target the Trezor device</p>
 *
...
public class MessageEventFixtures {
   ...
   */
  public static Features newStandardFeatures(WalletMode walletMode) {

    switch (walletMode) {
      case TREZOR:
        return TrezorMessageEventFixtures.newStandardFeatures(STANDARD_LABEL);
      case KEEP_KEY:
        return KeepKeyMessageEventFixtures.newStandardFeatures(STANDARD_LABEL);
      default:
   ...
   */
  public static Features newWipedFeatures(WalletMode walletMode) {

    switch (walletMode) {
      case TREZOR:
        return TrezorMessageEventFixtures.newWipedFeatures(STANDARD_LABEL);
      case KEEP_KEY:
        return KeepKeyMessageEventFixtures.newWipedFeatures(STANDARD_LABEL);
      default:
        throw new IllegalStateException("Unsupported wallet mode: " + walletMode.name());
    }
   ...
   */
  public static Features newUnsupportedFirmwareFeatures(WalletMode walletMode) {

    switch (walletMode) {
      case TREZOR:
        return TrezorMessageEventFixtures.newUnsupportedFirmwareFeatures(STANDARD_LABEL);
      case KEEP_KEY:
        return KeepKeyMessageEventFixtures.newUnsupportedFirmwareFeatures(STANDARD_LABEL);
      default:
        throw new IllegalStateException("Unsupported wallet mode: " + walletMode.name());
    }
   ...
   */
  public static Features newUnsupportedConfigurationPassphraseFeatures(WalletMode walletMode) {

    switch (walletMode) {
      case TREZOR:
        return TrezorMessageEventFixtures.newUnsupportedConfigurationPassphraseFeatures(STANDARD_LABEL);
      case KEEP_KEY:
        return KeepKeyMessageEventFixtures.newUnsupportedConfigurationPassphraseFeatures(STANDARD_LABEL);
      default:
        throw new IllegalStateException("Unsupported wallet mode: " + walletMode.name());
    }
   ...
   */
  public static Features newDeprecatedFirmwareFeatures(WalletMode walletMode) {

    switch (walletMode) {
      case TREZOR:
        return TrezorMessageEventFixtures.newDeprecatedFirmwareFeatures(STANDARD_LABEL);
      case KEEP_KEY:
        return KeepKeyMessageEventFixtures.newDeprecatedFirmwareFeatures(STANDARD_LABEL);
      default:
        throw new IllegalStateException("Unsupported wallet mode: " + walletMode.name());
    }
