 ...
 *  
 */
public class TrezorInitialisedDeprecatedFirmwareFixture extends AbstractHardwareWalletFixture {

  public TrezorInitialisedDeprecatedFirmwareFixture(String name) {
    super(name);
  }
  ...
  /**
   * <p>Configure for a FEATURES based on deprecated firmware features</p>
   * <p>Fires low level messages that trigger state changes in the MultiBit Hardware FSM</p>
   *
   * @param client The mock client
   */
