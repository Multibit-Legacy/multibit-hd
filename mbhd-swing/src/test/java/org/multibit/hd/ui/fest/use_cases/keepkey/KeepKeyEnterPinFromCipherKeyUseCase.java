 ...
 * @since 0.0.5
 */
public class KeepKeyEnterPinFromCipherKeyUseCase extends AbstractHardwareWalletFestUseCase {

  /**
   * @param window                The FEST window frame fixture
   * @param hardwareWalletFixture The hardware wallet fixture
   */
  public KeepKeyEnterPinFromCipherKeyUseCase(FrameFixture window, HardwareWalletFixture hardwareWalletFixture) {
