 ...
 * @since 0.0.5
 */
public class TrezorRequestCipherKeyUseCase extends AbstractHardwareWalletFestUseCase {

  /**
   * @param window                The FEST window frame fixture
   * @param hardwareWalletFixture The hardware wallet fixture
   */
  public TrezorRequestCipherKeyUseCase(FrameFixture window, HardwareWalletFixture hardwareWalletFixture) {
