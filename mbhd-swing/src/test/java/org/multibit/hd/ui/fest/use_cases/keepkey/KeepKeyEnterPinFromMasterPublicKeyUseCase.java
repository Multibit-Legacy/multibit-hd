 ...
 * <ul>
 * <li>Verify the Keepkey create wallet enter PIN panel (unlock)</li>
 * </ul>
 *
 * @since 0.0.8
 */
public class KeepKeyEnterPinFromMasterPublicKeyUseCase extends AbstractHardwareWalletFestUseCase {

  /**
   * @param window                The FEST window frame fixture
   * @param hardwareWalletFixture The hardware wallet fixture
   */
  public KeepKeyEnterPinFromMasterPublicKeyUseCase(FrameFixture window, HardwareWalletFixture hardwareWalletFixture) {
  ...
  public void execute(Map<String, Object> parameters) {
    ...
    // Click some buttons
    window
      .button(CredentialsState.CREDENTIALS_ENTER_PIN_FROM_MASTER_PUBLIC_KEY.name() + ".button_1")
      .requireEnabled()
      .click();
    window
      .button(CredentialsState.CREDENTIALS_ENTER_PIN_FROM_MASTER_PUBLIC_KEY.name() + ".button_2")
      .requireEnabled()
      .click();
    window
      .button(CredentialsState.CREDENTIALS_ENTER_PIN_FROM_MASTER_PUBLIC_KEY.name() + ".button_3")
      .requireEnabled()
      .click();
    window
      .button(CredentialsState.CREDENTIALS_ENTER_PIN_FROM_MASTER_PUBLIC_KEY.name() + ".button_4")
      .requireEnabled()
      .click();

    // Check that the PIN entry has populated
    window
      .textBox(CredentialsState.CREDENTIALS_ENTER_PIN_FROM_MASTER_PUBLIC_KEY.name() + ".textbox")
      .requireText("****");
