 ...
 * @since 0.0.5
 */
public class TrezorEnterPinFromSignTransactionUseCase extends AbstractHardwareWalletFestUseCase {

  /**
   * @param window                The FEST window frame fixture
   * @param hardwareWalletFixture The hardware wallet fixture
   */
  public TrezorEnterPinFromSignTransactionUseCase(FrameFixture window, HardwareWalletFixture hardwareWalletFixture) {
