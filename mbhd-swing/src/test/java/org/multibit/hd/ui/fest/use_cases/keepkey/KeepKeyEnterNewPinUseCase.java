 ...
 * <ul>
 * <li>Verify the Keepkey create wallet enter new PIN panel</li>
 * </ul>
 *
 * @since 0.0.5
 */
public class KeepKeyEnterNewPinUseCase extends AbstractHardwareWalletFestUseCase {

  /**
   * @param window                The FEST window frame fixture
   * @param hardwareWalletFixture The hardware wallet fixture
   */
  public KeepKeyEnterNewPinUseCase(FrameFixture window, HardwareWalletFixture hardwareWalletFixture) {
