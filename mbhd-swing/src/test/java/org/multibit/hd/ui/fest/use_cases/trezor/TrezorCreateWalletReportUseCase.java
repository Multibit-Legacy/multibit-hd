 ...
 * @since 0.0.5
 */
public class TrezorCreateWalletReportUseCase extends AbstractHardwareWalletFestUseCase {

  /**
   * @param window                The FEST window frame fixture
   * @param hardwareWalletFixture The hardware wallet fixture
   */
  public TrezorCreateWalletReportUseCase(FrameFixture window, HardwareWalletFixture hardwareWalletFixture) {
