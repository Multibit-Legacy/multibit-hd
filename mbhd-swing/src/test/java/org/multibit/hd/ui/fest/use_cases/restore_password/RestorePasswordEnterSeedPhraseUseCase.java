 ...
 *
 */
public class RestorePasswordEnterSeedPhraseUseCase extends AbstractFestUseCase {

  public RestorePasswordEnterSeedPhraseUseCase(FrameFixture window) {
    super(window);
  }
  ...
  public void execute(Map<String, Object> parameters) {
    ...
    assertLabelText(MessageKey.RESTORE_PASSWORD_SEED_PHRASE_TITLE);
