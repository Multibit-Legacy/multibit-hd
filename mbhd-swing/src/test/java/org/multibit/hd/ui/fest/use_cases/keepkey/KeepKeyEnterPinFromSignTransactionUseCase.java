 ...
 * @since 0.0.5
 */
public class KeepKeyEnterPinFromSignTransactionUseCase extends AbstractHardwareWalletFestUseCase {

  /**
   * @param window                The FEST window frame fixture
   * @param hardwareWalletFixture The hardware wallet fixture
   */
  public KeepKeyEnterPinFromSignTransactionUseCase(FrameFixture window, HardwareWalletFixture hardwareWalletFixture) {
