 ...
 * <ul>
 * <li>Verify the welcome wizard "restore wallet no date stamp and credentials" panel view</li>
 * </ul>
 *
 * @since 0.0.1
 *
 */
public class RestoreWalletNoDateStampUseCase extends AbstractFestUseCase {

  public RestoreWalletNoDateStampUseCase(FrameFixture window) {
    super(window);
  }
  ...
  public void execute(Map<String, Object> parameters) {
    ...
    // Clear text instead of date stamp
    window
      .textBox(MessageKey.TIMESTAMP.getKey())
      .setText("")
        // Trigger the key release action
