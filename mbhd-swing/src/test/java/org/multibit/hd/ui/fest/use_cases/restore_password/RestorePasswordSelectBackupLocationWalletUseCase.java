 ...
 *  
 */
public class RestorePasswordSelectBackupLocationWalletUseCase extends AbstractFestUseCase {

  public RestorePasswordSelectBackupLocationWalletUseCase(FrameFixture window) {
    super(window);
  }
