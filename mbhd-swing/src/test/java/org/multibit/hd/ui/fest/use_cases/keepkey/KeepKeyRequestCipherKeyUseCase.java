 ...
 * <ul>
 * <li>Verify the Keepkey "request cipher key" screen</li>
 * </ul>
 *
 ...
 * @since 0.0.5
 */
public class KeepKeyRequestCipherKeyUseCase extends AbstractHardwareWalletFestUseCase {

  /**
   * @param window                The FEST window frame fixture
   * @param hardwareWalletFixture The hardware wallet fixture
   */
  public KeepKeyRequestCipherKeyUseCase(FrameFixture window, HardwareWalletFixture hardwareWalletFixture) {
