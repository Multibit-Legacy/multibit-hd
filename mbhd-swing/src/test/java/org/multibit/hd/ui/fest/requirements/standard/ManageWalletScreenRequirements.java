...
import org.multibit.hd.ui.fest.use_cases.standard.sidebar.manage_wallet.change_password.VerifyChangePasswordUseCase;
import org.multibit.hd.ui.fest.use_cases.standard.sidebar.manage_wallet.edit_wallet.ShowThenCancelEditWalletUseCase;
import org.multibit.hd.ui.fest.use_cases.standard.sidebar.manage_wallet.empty_wallet.ShowThenCancelEmptyWalletUseCase;
import org.multibit.hd.ui.fest.use_cases.standard.sidebar.manage_wallet.payment_settings.ShowThenCancelPaymentSettingsUseCase;
import org.multibit.hd.ui.fest.use_cases.standard.sidebar.manage_wallet.payment_settings.VerifyPaymentSettingsBlockExplorerUseCase;
import org.multibit.hd.ui.fest.use_cases.standard.sidebar.manage_wallet.repair_wallet.ShowThenCancelRepairWalletUseCase;
import org.multibit.hd.ui.fest.use_cases.standard.sidebar.manage_wallet.wallet_details.ShowThenCancelWalletDetailsUseCase;
