 ...
 *  
 */
public class ChangePinConfirmChangePinPanelView extends AbstractHardwareWalletWizardPanelView<ChangePinWizardModel, ChangePinEnterPinPanelModel> {

  /**
   * @param wizard The wizard managing the states
   */
  public ChangePinConfirmChangePinPanelView(AbstractHardwareWalletWizard<ChangePinWizardModel> wizard, String panelName) {
  ...
  public void afterShow() {
    ...
    switch (getWizardModel().getWalletMode()) {
      ...
      case TREZOR:
        hardwareDisplayMaV.getView().setDisplayText(MessageKey.TREZOR_CHANGE_PIN_DISPLAY);
        break;
      case KEEP_KEY:
        hardwareDisplayMaV.getView().setDisplayText(MessageKey.KEEP_KEY_CHANGE_PIN_DISPLAY);
        break;
      default:
