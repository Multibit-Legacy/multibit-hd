 ...
 *
 */
public class TrezorToolsReportPanelView extends AbstractWizardPanelView<TrezorToolsWizardModel, TrezorToolsReportPanelModel> {
   ...
   */
  public TrezorToolsReportPanelView(AbstractWizard<TrezorToolsWizardModel> wizard, String panelName) {
  ...
  public void newPanelModel() {
    ...
    TrezorToolsReportPanelModel panelModel = new TrezorToolsReportPanelModel(
      getPanelName()
    );
