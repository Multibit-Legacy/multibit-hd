 ...
 *
 */
public class TrezorToolsWipeDevicePanelView extends AbstractWizardPanelView<TrezorToolsWizardModel, TrezorToolsWipeDevicePanelModel> {
  ...
  public void newPanelModel() {
    ...
    TrezorToolsWipeDevicePanelModel panelModel = new TrezorToolsWipeDevicePanelModel(
      getPanelName()
    );
