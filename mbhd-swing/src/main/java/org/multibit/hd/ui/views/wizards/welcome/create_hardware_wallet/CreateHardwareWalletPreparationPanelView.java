...
public class CreateHardwareWalletPreparationPanelView extends AbstractWizardPanelView<WelcomeWizardModel, String> {
  ...
  public void initialiseContent(JPanel contentPanel) {
    ...
    note1Label = Labels.newNoteLabel(MessageKey.HARDWARE_PREPARATION_NOTE_1, new Object[] {getWizardModel().getWalletMode().brand()});
    ...
    note2Label = Labels.newNoteLabel(MessageKey.HARDWARE_PREPARATION_NOTE_2, new Object[] {getWizardModel().getWalletMode().brand()});
    ...
    note3Label = Labels.newNoteLabel(MessageKey.HARDWARE_PREPARATION_NOTE_3, new Object[] {getWizardModel().getWalletMode().brand()});
    ...
    note4Label = Labels.newNoteLabel(MessageKey.HARDWARE_PREPARATION_NOTE_4, new Object[] {getWizardModel().getWalletMode().brand()});
    ...
    note5Label = Labels.newNoteLabel(MessageKey.HARDWARE_PREPARATION_NOTE_5, new Object[] {getWizardModel().getWalletMode().brand()});
    ...
    note6Label = Labels.newNoteLabel(MessageKey.HARDWARE_PREPARATION_NOTE_6, new Object[] {getWizardModel().getWalletMode().brand()});
