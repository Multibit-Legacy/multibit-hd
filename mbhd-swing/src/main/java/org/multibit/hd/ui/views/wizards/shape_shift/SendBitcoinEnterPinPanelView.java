 ...
 *  
 */
public class SendBitcoinEnterPinPanelView extends AbstractWizardPanelView<SendBitcoinWizardModel, SendBitcoinEnterPinPanelModel> {

  private static final Logger log = LoggerFactory.getLogger(SendBitcoinEnterPinPanelView.class);
  ...
  public void newPanelModel() {
    ...
    final SendBitcoinEnterPinPanelModel panelModel = new SendBitcoinEnterPinPanelModel(
      getPanelName(),
