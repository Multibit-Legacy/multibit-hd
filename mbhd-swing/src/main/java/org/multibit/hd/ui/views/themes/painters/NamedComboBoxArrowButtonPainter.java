...
public class NamedComboBoxArrowButtonPainter extends AbstractNamedRegionPainter {
  ...
  private Color color2 = adjustBackgroundColor(0.021348298f, -0.56289876f, 0.2588235f, 0);
  private Color color3 = adjustBackgroundColor(0.010237217f, -0.55799407f, 0.20784312f, 0);
  private Color color4 = new Color(255, 200, 0, 255);
  private Color color5 = adjustBackgroundColor(0.021348298f, -0.59223604f, 0.35294116f, 0);
  private Color color6 = adjustBackgroundColor(0.02391243f, -0.5774183f, 0.32549018f, 0);
  private Color color7 = adjustBackgroundColor(0.021348298f, -0.56722116f, 0.3098039f, 0);
  private Color color8 = adjustBackgroundColor(0.021348298f, -0.567841f, 0.31764704f, 0);
  private Color color9 = adjustForegroundColor(-0.6111111f, -0.110526316f, -0.74509805f, -191);
  private Color color10 = adjustBackgroundColor(5.1498413E-4f, -0.34585923f, -0.007843137f, 0);
  private Color color11 = adjustBackgroundColor(5.1498413E-4f, -0.095173776f, -0.25882354f, 0);
  private Color color12 = adjustBackgroundColor(0.004681647f, -0.6197143f, 0.43137252f, 0);
  private Color color13 = adjustBackgroundColor(0.0023007393f, -0.46825016f, 0.27058822f, 0);
  private Color color14 = adjustBackgroundColor(5.1498413E-4f, -0.43866998f, 0.24705881f, 0);
  private Color color15 = adjustBackgroundColor(5.1498413E-4f, -0.4625541f, 0.35686272f, 0);
  private Color color16 = adjustBackgroundColor(0.0013483167f, -0.1769987f, -0.12156865f, 0);
  private Color color17 = adjustBackgroundColor(0.059279382f, 0.3642857f, -0.43529415f, 0);
  private Color color18 = adjustBackgroundColor(0.004681647f, -0.6198413f, 0.43921566f, 0);
  private Color color19 = adjustBackgroundColor(0.0023007393f, -0.48084703f, 0.33725488f, 0);
  private Color color20 = adjustBackgroundColor(5.1498413E-4f, -0.4555341f, 0.3215686f, 0);
  private Color color21 = adjustBackgroundColor(5.1498413E-4f, -0.4757143f, 0.43137252f, 0);
  private Color color22 = adjustBackgroundColor(-0.57865167f, -0.6357143f, -0.54901963f, 0);
  private Color color23 = adjustBackgroundColor(-3.528595E-5f, 0.018606722f, -0.23137257f, 0);
  private Color color24 = adjustBackgroundColor(-4.2033195E-4f, -0.38050595f, 0.20392156f, 0);
  private Color color25 = adjustBackgroundColor(7.13408E-4f, -0.064285696f, 0.027450979f, 0);
  private Color color26 = adjustBackgroundColor(0.0f, -0.00895375f, 0.007843137f, 0);
  private Color color27 = adjustBackgroundColor(8.9377165E-4f, -0.13853917f, 0.14509803f, 0);
  private Color color28 = adjustBackgroundColor(-0.57865167f, -0.6357143f, -0.37254906f, 0);
  private Color color29 = adjustBackgroundColor(-0.57865167f, -0.6357143f, -0.5254902f, 0);
