 ...
 * <ul>
 * <li><code>H</code>: The generic handler class (e.g. {@link QuitHandlerInvocationHandler}</li>
 * <li><code>E</code>: The generic event class (e.g. {@link org.multibit.hd.ui.platform.listener.GenericQuitEvent}</li>
...
public abstract class BaseMacResponseInvocationHandler<H extends GenericHandler, E extends GenericEvent, R extends GenericEvent> implements InvocationHandler {
  ...
  /**
   * <p>Create a proxy instance of {@link org.multibit.hd.ui.platform.listener.GenericEvent}
