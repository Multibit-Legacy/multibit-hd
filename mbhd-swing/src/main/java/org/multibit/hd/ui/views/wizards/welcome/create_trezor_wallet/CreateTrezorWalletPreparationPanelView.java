...
public class CreateTrezorWalletPreparationPanelView extends AbstractWizardPanelView<WelcomeWizardModel, String> {
  ...
  public CreateTrezorWalletPreparationPanelView(AbstractWizard<WelcomeWizardModel> wizard, String panelName) {
    ...
    super(wizard, panelName, AwesomeIcon.SHIELD, MessageKey.CREATE_HARDWARE_WALLET_PREPARATION_TITLE, new Object[] { wizard.getWizardModel().getMode().brand()});
  ...
  public void initialiseContent(JPanel contentPanel) {
    ...
    note1Label = Labels.newNoteLabel(MessageKey.HARDWARE_PREPARATION_NOTE_1, new Object[] {getWizardModel().getMode().brand()});
    ...
    note2Label = Labels.newNoteLabel(MessageKey.HARDWARE_PREPARATION_NOTE_2, new Object[] {getWizardModel().getMode().brand()});
    ...
    note3Label = Labels.newNoteLabel(MessageKey.HARDWARE_PREPARATION_NOTE_3, new Object[] {getWizardModel().getMode().brand()});
    ...
    note4Label = Labels.newNoteLabel(MessageKey.HARDWARE_PREPARATION_NOTE_4, new Object[] {getWizardModel().getMode().brand()});
    ...
    note5Label = Labels.newNoteLabel(MessageKey.HARDWARE_PREPARATION_NOTE_5, new Object[] {getWizardModel().getMode().brand()});
    ...
    note6Label = Labels.newNoteLabel(MessageKey.HARDWARE_PREPARATION_NOTE_6, new Object[] {getWizardModel().getMode().brand()});
