 ...
 * @since 0.0.1
 */
public class DisplayPaymentRequestView extends AbstractComponentView<DisplayPaymentRequestModel> {
   ...
   */
  public DisplayPaymentRequestView(DisplayPaymentRequestModel model) {
    super(model);
  }
