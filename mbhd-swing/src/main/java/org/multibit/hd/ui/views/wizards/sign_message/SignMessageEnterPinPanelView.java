 ...
 * <ul>
 * <li>Sign message: Enter pin</li>
 * </ul>
 *
 * @since 0.0.8
 *  
 */
public class SignMessageEnterPinPanelView extends AbstractWizardPanelView<SignMessageWizardModel, SignMessageEnterPinPanelModel> {

  private static final Logger log = LoggerFactory.getLogger(SignMessageEnterPinPanelView.class);
  ...
  public void newPanelModel() {
    ...
    final SignMessageEnterPinPanelModel panelModel = new SignMessageEnterPinPanelModel(
      getPanelName(),
