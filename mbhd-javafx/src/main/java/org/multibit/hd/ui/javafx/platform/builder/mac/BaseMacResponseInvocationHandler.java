...
import org.multibit.hd.ui.javafx.platform.handler.GenericHandler;
import org.multibit.hd.ui.javafx.platform.listener.GenericEvent;
 ...
 * <ul>
 * <li><code>H</code>: The generic handler class (e.g. {@link org.multibit.hd.ui.javafx.platform.builder.mac.QuitHandlerInvocationHandler}</li>
 * <li><code>E</code>: The generic event class (e.g. {@link org.multibit.hd.ui.javafx.platform.listener.GenericQuitEvent}</li>
 * <li><code>R</code>: The generic response class (e.g. {@link org.multibit.hd.ui.javafx.platform.listener.GenericQuitResponse}</li>
 * </ul>
 *
 * @since 0.3.0
 */
public abstract class BaseMacResponseInvocationHandler<H extends GenericHandler, E extends GenericEvent, R extends GenericEvent> implements InvocationHandler {
  ...
  /**
   * <p>Create a proxy instance of {@link org.multibit.hd.ui.javafx.platform.listener.GenericEvent}
  ...
  private <E> E createGenericEvent(final Object nativeEvent) {
    ...
    // when the invocation handler is called against its methods
